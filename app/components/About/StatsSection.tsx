      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="w-full md:w-[500px]">
            <h2 className="text-[20px] md:text-[28px] font-bold text-[#19191B] leading-[32px] md:leading-[40px]">
          ...
          <div className="w-full md:w-[800px]">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4">
              {stats.map((stat) => (
                <div key={stat.number} className="flex flex-col gap-2">
                  <div className="text-[32px] md:text-[48px] font-bold text-[#19191B] leading-[40px] md:leading-[60px]">
                    {stat.number}
                  </div>
                  <p className="text-[16px] md:text-[14px] text-[#19191B] leading-[24px] md:leading-[20px]">
                    {stat.description}
                  </p>
                </div>
              ))}
