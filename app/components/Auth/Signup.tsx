...
import { SignupComingSoonModal } from "@/app/components/ui/SignupComingSoonModal";
...
export const Signup = () => {
  ...
  const [isSignupComingSoonOpen, setIsSignupComingSoonOpen] = useState(false);
  ...
  const handleContinueClick = () => {
    setIsSignupComingSoonOpen(true);
  };
  ...
  return (
    <>
            ...
            <div className="bg-white rounded-[24px] border border-[#E5E5E5] p-[24px]">
              ...
              <div className="pt-[32px] md:pt-[40px]">
                <Button
                  ...
                  className="w-full h-[48px] bg-[#293483] text-white text-[16px] font-bold rounded-[72px] hover:bg-[#212A69]"
                >
                  Continue
                </Button>
              </div>
      ...
      <SignupComingSoonModal
        isOpen={isSignupComingSoonOpen}
        onClose={() => setIsSignupComingSoonOpen(false)}
      />
    </>
  );
};
