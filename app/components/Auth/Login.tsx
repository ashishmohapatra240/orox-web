...
import { LoginComingSoonModal } from "@/app/components/ui/LoginComingSoonModal";
...
export const Login = () => {
  ...
  const [isLoginComingSoonOpen, setIsLoginComingSoonOpen] = useState(false);
  ...
  return (
    <>
      ...
      <LoginComingSoonModal
        isOpen={isLoginComingSoonOpen}
        onClose={() => setIsLoginComingSoonOpen(false)}
      />
    </>
  );
};
