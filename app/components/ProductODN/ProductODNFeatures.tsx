  ...
  const odnFeatures = [
    {
      ...
      description: "All weather strategies designed for consistent, stable yields.",
    },
    {
      icon: "/images/features/hands-off.svg",
      title: "Hands-off investing",
      description: "A fully automated system—no market timing, no daily management needed.",
    },
    {
      icon: "/images/features/90-day.svg",
      title: "90-day cycle",
      description: "Structured investment periods to optimise performance and reduce risk.",
    },
    {
